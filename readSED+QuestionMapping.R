...
strFile <- "PSES-SED-2011-2018.xls"
...
dtQuestions22 <- dtSED[ ,12:17] %>% unique(by='n2018'); 
dtQuestions22[,1:5]
cols <- 2:5
...
psesSED.plotQuestionByTime_lines <- function(.dt, .strQuestion) {
  ...
  g2 <- ggplot( .dt ) + theme_bw() + # + theme_economist_white() +
    ...
    scale_x_continuous(limits=c(2010,2019),breaks=c(2011,2014,2016,2018)) 
